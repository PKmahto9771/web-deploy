/**
 * This code was generated by v0 by web-deploy.
      ...
      {deployed && <Card className="w-full max-w-md mt-8">
        ...
        <CardContent>
          <div className="space-y-2">
            ...
            <Input id="deployed-url" readOnly type="url" value={`http://${uploadId}.webdeploy:3001/index.html`} />
          </div>
          <br />
          <Button className="w-full" variant="outline">
            <a href={`http://${uploadId}.webdeploy:3001/index.html`} target="_blank">
              Visit Website
            </a>
          </Button>
        </CardContent>
